...
Anything that is free right now will remain free. The core application functionality will always be free. I will be adopting a subscription model where you would pay monthly or annually to use the the premium features.
