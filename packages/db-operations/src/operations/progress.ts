...
export const makeProgressTable = ({ getDb }: OperationDeps) =>
  ({
    wordsAdded: {
      ...
      cacheOptions: {
        queryKey: ["turso.progress.wordsAdded"],
      },
    },
    wordsLearned: {
      query: async (): Promise<{
      ...
      cacheOptions: {
        queryKey: ["turso.progress.wordsLearned"],
      },
    },
    difficultWords: {
      query: async (): Promise<{
      ...
      cacheOptions: {
        queryKey: ["turso.progress.difficultWords"],
      },
    },
    workloadForecast: {
      query: async ({
      ...
      cacheOptions: {
        queryKey: ["turso.progress.workloadForecast"],
      },
    },
    streak: {
      query: async (): Promise<{
      ...
      cacheOptions: {
        queryKey: ["turso.progress.streak"],
      },
    },
    recordReview: {
      ...
      cacheOptions: {
        queryKey: ["turso.progress.recordReview"],
      },
    },
    recentReviewWords: {
      query: async (
      ...
      cacheOptions: {
        queryKey: ["turso.progress.recentReviewWords"],
      },
    },
